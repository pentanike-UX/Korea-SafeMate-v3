    ...
    <footer className="border-t border-white/10 bg-[#131a2a] text-white dark:bg-[#05070d]">
      <div className="w-full px-4 py-10 sm:px-6 sm:py-12 md:px-8 md:py-14 xl:px-10">
        <div className="border-b border-white/12 pb-8 sm:pb-10">
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_1px_minmax(17rem,20rem)] lg:items-start lg:gap-8">
            <div className="space-y-6">
              ...
              <nav className="grid max-w-3xl grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-x-4" aria-label="Footer">
                <div>
            ...
            <div className="hidden h-full min-h-[12rem] bg-white/12 lg:block" aria-hidden />

            <div className="rounded-2xl border border-white/12 bg-white/[0.03] p-4 sm:p-5">
              <p className="text-[11px] font-semibold tracking-wider text-white/55 uppercase">{tFooter("operations")}</p>
              <div className="mt-3 space-y-4">
                <FooterPreferences />
                <div className="border-t border-white/10 pt-3">
                  <p className="text-[11px] font-semibold tracking-wide text-white/55 uppercase">{tFooter("admin")}</p>
                  <NextLink
                    href="/admin/dashboard"
                    className="inline-flex min-h-10 items-center rounded-[var(--radius-md)] text-sm font-medium text-white/70 underline-offset-4 transition-colors hover:text-white hover:underline"
                  >
