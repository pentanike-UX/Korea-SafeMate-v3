...
const IMG = {
  palace: "https://images.unsplash.com/photo-1583839729043-783a4d1fe361?w=1200&q=80",
  gwGate: "https://images.unsplash.com/photo-1590559899731-a382839554ff?w=1200&q=80",
  seoulPlaza: "https://images.unsplash.com/photo-1517154421773-0529f29ea451?w=1200&q=80",
  statue: "https://images.unsplash.com/photo-1578469550956-0b16cdfdb495?w=1200&q=80",
  cafeIn: "https://images.unsplash.com/photo-1495474472287-71871a1f22fe?w=1200&q=80",
  cafeOut: "https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=1200&q=80",
  cafeWindow: "https://images.unsplash.com/photo-1501339849922-c21129a094ea?w=1200&q=80",
  gangnamStreet: "https://images.unsplash.com/photo-1548115184-bc6547d06a58?w=1200&q=80",
  gangnamNight: "https://images.unsplash.com/photo-1512486130939-2c4f79635e84?w=1200&q=80",
  alley: "https://images.unsplash.com/photo-1566988102596-43bb7b84db8f?w=1200&q=80",
  crosswalk: "https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=1200&q=80",
} as const;
...
function journeyGwanghwamunClassic(postId: string): RouteJourney {
  ...
  const spots: RouteSpot[] = [
    spot(postId, 1, {
      ...
      image_urls: [IMG.seoulPlaza, IMG.crosswalk],
    ...
    spot(postId, 2, {
      ...
      image_urls: [IMG.statue, IMG.gwGate],
    ...
    spot(postId, 3, {
      ...
      image_urls: [IMG.seoulPlaza, IMG.palace],
    ...
    spot(postId, 4, {
      ...
      image_urls: [IMG.palace, IMG.palace],
...
function journeyGangnamWalk(postId: string): RouteJourney {
  ...
  const spots: RouteSpot[] = [
    spot(postId, 1, {
      ...
      image_urls: [IMG.gangnamStreet, IMG.crosswalk],
    ...
    spot(postId, 2, {
      ...
      image_urls: [IMG.cafeOut, IMG.cafeIn],
    ...
    spot(postId, 3, {
      ...
      image_urls: [IMG.cafeWindow, IMG.cafeIn],
    ...
    spot(postId, 4, {
      ...
      image_urls: [IMG.gangnamNight, IMG.gangnamStreet],
...
function journeyGwangShort(postId: string): RouteJourney {
  ...
  const spots: RouteSpot[] = [
    spot(postId, 1, {
      ...
      image_urls: [IMG.gwGate, IMG.seoulPlaza],
    ...
    spot(postId, 2, {
      ...
      image_urls: [IMG.seoulPlaza, IMG.statue],
    ...
    spot(postId, 3, {
      ...
      image_urls: [IMG.palace, IMG.alley],
...
const SAMPLE_DEFINITIONS: SampleDef[] = [
  ...
  { withRoute: true, journey: journeyGwanghwamunClassic, title: "사진 찍기 좋은 광화문 루트", summary: "광장·동상·궁궐 담장을 프레임 나누기 좋은 순서로 배치했습니다.", body: "인물 사진은 배경이 단순한 순간을 골라 찍고, 풍경은 삼각대 없이도 될 각도를 먼저 찾습니다.", tags: ["광화문권", "사진", "풍경"], category_slug: "local-tips", kind: "local_tip", cover_image_url: IMG.seoulPlaza, post_format: "hybrid", route_highlights: ["동상은 기준점 샷", "광장은 넓게", "담장은 대각선 구도"] },
  { withRoute: true, journey: journeyGangnamWalk, title: "강남 감성 카페 코스 — 창가와 실내를 번갈아", summary: "외부 테라스 느낌이 나는 파사드와 실내 좌석을 둘 다 경험합니다.", body: "첫 카페는 밝은 실내, 둘째는 조용한 층을 고르면 피로도가 덜 쌓입니다.", tags: ["강남역권", "카페", "감성"], category_slug: "food", kind: "food", cover_image_url: IMG.cafeOut, post_format: "route" },
  { withRoute: true, journey: journeyGwangShort, title: "서울 첫날 오전 — 광화문만으로도 충분한 이유", summary: "입국 직후 무리한 이동 대신 광장·궁 일대만 잡아도 체감 만족이 큽니다.", body: "짐이 있으면 반나절 코스는 광장 중심이 피로 대비 효율이 좋습니다.", tags: ["광화문권", "첫날", "오전"], category_slug: "practical", kind: "practical", cover_image_url: IMG.gwGate, post_format: "route" },
  { withRoute: true, journey: journeyGangnamWalk, title: "강남역 ‘짧은 산책’ 루트", summary: "1시간 안팎으로 테헤란로 분위기만 담고 돌아오는 코스.", body: "쇼핑몰 안 말고 도보로 ‘거리의 속도감’을 느끼는 데 초점을 둡니다.", tags: ["강남역권", "산책", "짧은코스"], category_slug: "hot-places", kind: "hot_place", cover_image_url: IMG.gangnamStreet, post_format: "route" },
  { withRoute: true, journey: journeyGwanghwamunClassic, title: "경복궁 가기 전 광장 체크리스트", summary: "만남·화장실·물·그늘만 정리하면 이후 동선이 매끄럽습니다.", body: "궁 안은 시간이 길어질 수 있어, 광장에서 기본 니즈를 먼저 해소하는 편이 좋습니다.", tags: ["광화문권", "준비", "경복궁"], category_slug: "practical", kind: "practical", cover_image_url: IMG.palace, post_format: "hybrid" },
  { withRoute: true, journey: journeyGangnamWalk, title: "강남 오후 — 카페와 거리 사진의 밸런스", summary: "카페 2스팟 + 거리 마무리로 피드 구성이 자연스럽습니다.", body: "같은 필터보다 ‘실내 따뜻함’과 ‘거리 차가움’ 대비가 기억에 남습니다.", tags: ["강남역권", "사진", "카페"], category_slug: "local-tips", kind: "local_tip", cover_image_url: IMG.cafeWindow, post_format: "route" },
  { withRoute: true, journey: journeyGwangShort, title: "광화문에서 세종대왕상까지 여유 루트", summary: "무리한 각도보다 ‘서 있는 위치’만 맞춰도 설명이 쉬워집니다.", body: "동행 시에는 기준점을 말로 설명하기보다 눈에 보이는 조형물 이름으로 맞춥니다.", tags: ["광화문권", "세종로", "만남"], category_slug: "local-tips", kind: "local_tip", cover_image_url: IMG.seoulPlaza, post_format: "route" },
  { withRoute: true, journey: journeyGangnamWalk, title: "강남역 ‘먹자·카페’ 밸런스 도보", summary: "군중 속에서도 큰 길을 붙잡고 이동하면 방향이 흔들리지 않습니다.", body: "배가 고프면 골목으로 짧게 빠지되, 복귀는 다시 큰 길로 오는 패턴이 안전합니다.", tags: ["강남역권", "식사", "도보"], category_slug: "food", kind: "food", cover_image_url: IMG.crosswalk, post_format: "route" },
  { withRoute: true, journey: journeyGwanghwamunClassic, title: "광화문 랜드마크 풀코스 — 이순신·세종·경복궁", summary: "요청하신 랜드마크를 한 루트에 묶었습니다.", body: "사진 포인트마다 2~3분만 쓰고 이동하면 전체 시간이 지켜집니다.", tags: ["광화문권", "이순신", "세종대왕", "경복궁"], category_slug: "hot-places", kind: "hot_place", cover_image_url: IMG.statue, post_format: "route", recommended_boost: 8 },
  { withRoute: true, journey: journeyGwangShort, title: "반나절 산책 — 광장 바람과 궁 담장", summary: "운동화만 준비돼 있으면 충분한 가벼운 코스입니다.", body: "언덕이 거의 없어 첫 방문자·시니어와 동행하기 무난합니다.", tags: ["광화문권", "산책", "가벼운코스"], category_slug: "hot-places", kind: "hot_place", cover_image_url: IMG.alley, post_format: "route" },
  { withRoute: true, journey: journeyGangnamWalk, title: "강남역 야간 분위기 — 네온과 카페 실내", summary: "밤에는 거리 밝기와 실내 조명 대비가 사진에 잘 먹습니다.", body: "야간 도보는 이어폰 볼륨을 낮추고 횡단을 한 박자 느리게 건너는 습관이 안전합니다.", tags: ["강남역권", "야경", "카페"], category_slug: "hot-places", kind: "hot_place", cover_image_url: IMG.gangnamNight, post_format: "hybrid" },
  { withRoute: true, journey: journeyGwanghwamunClassic, title: "첫 서울 방문자용 짧은 추천 루트", summary: "‘한 번에 서울’이 느껴지는 최소 동선입니다.", body: "다음 날 홍대·강남으로 확장하기 전 오리엔테이션으로 쓰기 좋습니다.", tags: ["광화문권", "첫방문", "추천"], category_slug: "local-tips", kind: "local_tip", cover_image_url: IMG.palace, post_format: "route" },
  ...
  { withRoute: false, title: "광화문에서 경복궁까지 ‘천천히’ 가는 마음가짐", summary: "지각 스트레스를 줄이려면 버퍼 20분을 광장에 둡니다.", body: "궁 입장 줄이 길면 담장 산책으로 만족도를 채우는 선택도 합리적입니다.", tags: ["광화문권", "경복궁", "여유"], category_slug: "local-tips", kind: "local_tip", cover_image_url: IMG.palace },
  { withRoute: false, title: "강남역 근처 실내 휴식 슬롯 잡기", summary: "밖이 붐비면 몰·카페 실내로 15분만 넣어도 컨디션이 회복됩니다.", body: "에어컨·난방이 강한 실내는 겉옷을 준비하고, 물을 조금씩 나눠 마십니다.", tags: ["강남역권", "휴식", "실내"], category_slug: "practical", kind: "practical", cover_image_url: IMG.cafeWindow },
  { withRoute: false, title: "광화문 랜드마크 사진 — 사람이 많을 때", summary: "높이보다 ‘거리’를 두고 찍으면 인파가 덜 붙습니다.", body: "연속 촬영으로 표정만 고르고, 통행 중에는 셔터를 잠시 멈춥니다.", tags: ["광화문권", "사진", "혼잡"], category_slug: "local-tips", kind: "local_tip", cover_image_url: IMG.gwGate },
  { withRoute: false, title: "테헤란로 카페 — 창가 자리의 햇빛", summary: "오후 서향 창가는 뜨거울 수 있어 음료 얼음량을 조절하세요.", body: "실내 사진은 창쪽 노출을 살짝 낮추면 거리 풍경이 살아납니다.", tags: ["강남역권", "카페", "오후"], category_slug: "food", kind: "food", cover_image_url: IMG.cafeIn },
  { withRoute: false, title: "서울 첫 방문 — 광화문이 좋은 이유 한 장으로", summary: "지하철·버스 접근, 안내 표지, 화장실·편의점 밀도가 균형 잡혀 있습니다.", body: "다음 코스(북촌·인사동 등)로 확장하기 전 ‘기준점’을 몸으로 익히기 좋습니다.", tags: ["광화문권", "첫방문", "오리엔테이션"], category_slug: "practical", kind: "practical", cover_image_url: IMG.seoulPlaza },
  { withRoute: false, title: "강남역 ‘짧은 약속’ 장소 잡기", summary: "10번·11번 출구 근처 큰 길을 기준으로 잡으면 설명이 짧아집니다.", body: "약속 변경 시에도 큰 길 기준으로만 말하면 재집결 속도가 빨라집니다.", tags: ["강남역권", "만남", "약속"], category_slug: "practical", kind: "practical", cover_image_url: IMG.crosswalk },
  { withRoute: false, title: "광화문·경복궁 사이 보행 매너", summary: "촬영·통행·자전거 도로를 한눈에 보고 속도를 맞춥니다.", body: "좁은 구간에서는 가방을 앞으로 돌려 여유 공간을 확보합니다.", tags: ["광화문권", "매너", "보행"], category_slug: "local-tips", kind: "local_tip", cover_image_url: IMG.alley },
];

function mergeSample(base: ContentPost, def: SampleDef): ContentPost {
  const route_journey = def.withRoute && def.journey ? def.journey(base.id) : undefined;
